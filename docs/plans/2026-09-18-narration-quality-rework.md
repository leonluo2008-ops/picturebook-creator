...
### C1. 感叹号三档规则 —— ✅ 已消解（2026-09-18 查实）
「打架」只存在于已删除的 update-todo 中；活文件单一口径：L4 画面文字三档 = ld-picturebook-l4-user-ironrule:338（封面 Xxxxxx! / 认知页全大写无感叹号 / 内页小写）；L3 旁白行 1 大小写按书内既有形式不强改（narration-review 2026-09-16 用户判词）。两层各管各的，无冲突，无需修改。
